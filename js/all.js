jQuery(document).ready(function($){
  ...
  onTop.modalizer = function() {
    $("input.modal-state").on("change", function() {
      ...
      var active_slider = $('div.video-wrapper[data-clip="' + chosenClip + '"]');
      var players = $(active_slider).find('iframe');
    ...
    $(".modal-fade-screen, .modal-close, .modal-content").on("click", function() {
